...
CarrotPanel::CarrotPanel(QWidget* parent) : QWidget(parent) {
  ...
  latLong_btn->setObjectName("top_btn");
  ...
  start_btn->setObjectName("top_btn");
  ...
  speed_btn->setObjectName("top_btn");
  ...
  latLongToggles->addItem(new CValueControl("CustomSR", "LAT: SteerRatiox0.1(0)", "Custom SteerRatio", "../assets/offroad/icon_road.png", 0, 300, 1));
  latLongToggles->addItem(new CValueControl("SteerRatioRate", "LAT: SteerRatioRatex0.01(100)", "SteerRatio apply rate", "../assets/offroad/icon_road.png", 30, 170, 1));
  ...
  latLongToggles->addItem(new CValueControl("LaneChangeNeedTorque", "LaneChange need torque", "", "../assets/offroad/icon_shell.png", 0, 1, 1));
  ...
  latLongToggles->addItem(new CValueControl("ComfortBrake", "LONG: Comfort Brake (240)", "x0.01", "../assets/offroad/icon_road.png", 200, 300, 1));
  ...
  latLongToggles->addItem(new CValueControl("CustomSteerMax", "LAT: CustomSteerMax(0)", "", "../assets/offroad/icon_road.png", 0, 30000, 5));
  ...
  startToggles->addItem(new ParamControl("EnableRadarTracks", "Enable Radar Track", "", "../assets/offroad/icon_shell.png", this));
  startToggles->addItem(new ParamControl("CanfdHDA2", "CAN-FD: HDA2 Mode", "", "../assets/offroad/icon_shell.png", this));
  ...
  startToggles->addItem(new CValueControl("CruiseOnDist", "CRUISE: Auto ON distance (0 cm)", "When GAS/Brake is OFF, Cruise ON when the lead car gets closer.", "../assets/offroad/icon_road.png", 0, 2500, 50));
  ...
  startToggles->addItem(new CValueControl("DisableMinSteerSpeed", "Disable Min.SteerSpeed", "", "../assets/offroad/icon_road.png", 0, 1, 1));
  ...
  startToggles->addItem(new CValueControl("AutoGasSyncSpeed", "Auto update Cruise speed", "", "../assets/offroad/icon_road.png", 0, 1, 1));



  startToggles->addItem(new CValueControl("SpeedFromPCM", "Read Cruise Speed from PCM", "Toyota: 1, Honda: 3", "../assets/offroad/icon_road.png", 0, 3, 1));
  ...
  startToggles->addItem(new ParamControl("HotspotOnBoot", "Hotspot automatically enabled after boot", "", "../assets/offroad/icon_shell.png", this));
  ...
  speedToggles->addItem(new CValueControl("AutoCurveSpeedLowerLimit", "CURVE: Lower limit speed(30)", "곡선 도로를 만나면 속도를 줄여줍니다. 최저속도", "../assets/offroad/icon_road.png", 30, 200, 5));
  ...
  speedToggles->addItem(new CValueControl("AutoNaviSpeedCtrlEnd", "Speed Camera Decel End(6s)", "감속 종료 시점을 설정합니다. 값이 크면 카메라에서 멀리 감속 완료", ".. / assets / offroad / icon_road.png", 3, 20, 1));
  speedToggles->addItem(new CValueControl("AutoNaviSpeedDecelRate", "Speed Camera Decel Ratex0.01m/s^2(80)", "낮으면 멀리서부터 감속함", ".. / assets / offroad / icon_road.png", 10, 200, 10));
  speedToggles->addItem(new CValueControl("AutoNaviSpeedSafetyFactor", "Speed Camera Safety Factor(105%)", "", ".. / assets / offroad / icon_road.png", 80, 120, 1));
  speedToggles->addItem(new CValueControl("AutoNaviSpeedBumpTime", "Speed Bump Time Distance (1s)", "", ".. / assets / offroad / icon_road.png", 1, 50, 1));
  speedToggles->addItem(new CValueControl("AutoNaviSpeedBumpSpeed", "Speed Bump Speed (35Km/h)", "", ".. / assets / offroad / icon_road.png", 10, 100, 5));
  speedToggles->addItem(new CValueControl("AutoNaviCountDownMode", "Navi Countdown Mode (2)", "0: off, 1:tbt+camera, 2:tbt+camera+bump", ".. / assets / offroad / icon_road.png", 0, 2, 1));
  ...
  speedToggles->addItem(new CValueControl("MapTurnSpeedFactor", "Map Turn Speed Factor(100)", "", ".. / assets / offroad / icon_road.png", 50, 300, 5));
  ...
  setStyleSheet(R"(
    ...
    QPushButton#top_btn:pressed { background-color: #4a4a4a; }
  )");
}
...
CValueControl::CValueControl(const QString& params, const QString& title, const QString& desc, const QString& icon, int min, int max, int unit)
    ...
    btnplus.setObjectName("value_btn");
    btnminus.setObjectName("value_btn");
    ...
    setStyleSheet(R"(
      ...
      QPushButton#value_btn:pressed { background-color: #4a4a4a; }
    )");
